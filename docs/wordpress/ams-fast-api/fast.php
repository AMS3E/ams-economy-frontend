 ...
 * `economy` — every offloaded-media URL this file built was 404ing.
 ...
 *  this plugin's install moved to economy.ams.com.kh, whose media lives in
 *  the `economy` bucket instead. Every fast-path media/program/episode URL
 *  built from this constant 404'd (confirmed live: WP REST's own offloaded
 *  source_url is https://s3.ams.com.kh/economy/..., not .../infotainment/...),
