...
// Cambodia 360° is split across a movie post, a tv_show, and independent hero
// artwork in WordPress. These pins match the homepage's verified pairing.
const MOVIE_POST_ID = 24747;
const HERO_IMAGE_ID = 79951;
const TV_SHOW_ID = 47504;
const PROGRAM_SLUG = "cambodia-360";
...
/** Cambodia 360° hero plus its WordPress-backed episode carousel. */
export default async function Cambodia360Feature() {
